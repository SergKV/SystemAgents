...
namespace DoJo2Agent.SR_AgentAdapter {
    ...
    public interface IMessageTransmissionService {
        ...
        bool TransmitMessage(DoJo2Agent.SR_AgentAdapter.CoreMessage message);
        ...
        System.IAsyncResult BeginTransmitMessage(DoJo2Agent.SR_AgentAdapter.CoreMessage message, System.AsyncCallback callback, object asyncState);
        
        bool EndTransmitMessage(System.IAsyncResult result);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMessageTransmissionServiceChannel : DoJo2Agent.SR_AgentAdapter.IMessageTransmissionService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MessageTransmissionServiceClient : System.ServiceModel.ClientBase<DoJo2Agent.SR_AgentAdapter.IMessageTransmissionService>, DoJo2Agent.SR_AgentAdapter.IMessageTransmissionService {
        ...
        public bool TransmitMessage(DoJo2Agent.SR_AgentAdapter.CoreMessage message) {
            return base.Channel.TransmitMessage(message);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public System.IAsyncResult BeginTransmitMessage(DoJo2Agent.SR_AgentAdapter.CoreMessage message, System.AsyncCallback callback, object asyncState) {
        ...
        private System.IAsyncResult OnBeginTransmitMessage(object[] inValues, System.AsyncCallback callback, object asyncState) {
            DoJo2Agent.SR_AgentAdapter.CoreMessage message = ((DoJo2Agent.SR_AgentAdapter.CoreMessage)(inValues[0]));
        ...
        public void TransmitMessageAsync(DoJo2Agent.SR_AgentAdapter.CoreMessage message) {
            this.TransmitMessageAsync(message, null);
        }
        
        public void TransmitMessageAsync(DoJo2Agent.SR_AgentAdapter.CoreMessage message, object userState) {
